...
SCHEMA_V2 = """{
  ...
  "valuation_comment": {"ko": "밸류에이션 해설 4~6문장. ★현재 PER·PBR·배당수익률·현재가·시가총액은 주가 따라 매일 바뀌므로 '정확한 수치'를 문장에 쓰지 말 것(그 값은 화면 카드가 실시간 표시). 대신 수준을 관계로 서술 — 예: 과거 거래 밴드 상단/하단, 업종 평균 상회/하회, 순자산 대비 프리미엄/할인. 단 잘 안 변하는 숫자(과거 PER 밴드, EPS·BPS·ROE·DPS, 다년 실적)는 인용 가능. 'TTM' 등 전문 용어 금지. '비싸다/싸다' 단정·권유 금지, 사실 비교만", "en": "..."},
