...
PAGE_NAMES = {
    # 홈이 둘이다. 둘 다 살아 있고 역할이 다르다 — '옛 주소' 가 아니다.
    #   /            첫 화면(랜딩). "한국 주식 전 종목 …" 소개와 검색. 로고를 누르면 온다.
    #   /Home.html   리포트 홈. 최신 리포트 · 업종별 주목 종목. 메뉴의 '홈' 이 여기로 온다.
    # 2026-09-15 까지 Home.html 을 '홈(구 주소)' 라고 적어 두는 바람에 보고서가
    # "단골이 옛 북마크에 갇혀 있다" 고 잘못 읽었다. 사장이 "옛 홈이 뭔데?" 라고 물어
    # 코드를 열어 보고 알았다. 이름표가 틀리면 해석이 통째로 틀린다.
    "/": "첫 화면(랜딩)",
    "/index.html": "첫 화면(랜딩)",
    "/Home.html": "리포트 홈",
    "/brief.html": "모닝 브리핑",
