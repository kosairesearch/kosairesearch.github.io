...
WEEK_COLS = [
    ...
    ("DAU(명)", "하루 평균 온 사람. 그 주 7일 각각 온 사람 수의 평균",
     "GA4 activeUsers 를 날짜별로 받아 7 로 나눈다", "아무도 안 온 날도 0 으로 쳐서 나눈다"),
    ("WAU(명)", "그 주 7일 동안 온 사람", "GA4 active7DayUsers (그 주 일요일 기준)",
     "방문자와 거의 같다. 방문자는 한 번이라도 온 사람, WAU 는 그중 활동한 사람이라 몇 명 적을 수 있다"),
    ("MAU(명)", "그 주 일요일 기준으로 지난 28일 동안 한 번이라도 온 사람",
     "GA4 active28DayUsers", "주 넷을 더한 것이 아니다. 같은 사람은 한 번만 센다"),
    ("DAU/MAU(%)", "DAU ÷ MAU × 100. 한 달에 온 사람이 하루에 몇 % 오나. 업계에서 습관(stickiness) 이라고 부른다",
