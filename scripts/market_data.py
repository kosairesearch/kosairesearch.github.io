...
SERIES = [
    ...
    ("kospi",    "코스피",         "^KS11",     2, ""),
    ("kosdaq",   "코스닥",         "^KQ11",     2, ""),
    # ── 여기부터는 브리핑 재료를 넓히려고 넣은 것들(2026-09-14) ──
    # 브리핑이 매일 같은 열두 가지를 훑었다. 재료의 '종류'가 열둘뿐이라
    # 고를 것이 없었다. 종류를 늘린다 — 규칙을 더하는 게 아니라 재료를 더한다.
    # 못 받으면 사실 블록의 '못 받은 값' 에 이름이 실리고 글에서는 빠진다.
    ("nikkei",   "닛케이",         "^N225",     2, ""),
    ("hangseng", "항셍",           "^HSI",      2, ""),
    ("shanghai", "상하이종합",      "000001.SS", 2, ""),
    ("nvda",     "엔비디아",        "NVDA",      2, "달러"),
    ("tsm",      "TSMC",          "TSM",       2, "달러"),
    ("mu",       "마이크론",        "MU",        2, "달러"),
    ("tsla",     "테슬라",         "TSLA",      2, "달러"),
    ("gold",     "금",            "GC=F",      2, "달러"),
    ("copper",   "구리",           "HG=F",      3, "달러"),
    ("natgas",   "천연가스",        "NG=F",      3, "달러"),
    ("vix",      "VIX",           "^VIX",      2, ""),
    ("btc",      "비트코인",        "BTC-USD",   0, "달러"),
]
# 사실 블록에서 묶어 보여 줄 때의 순서와 이름
SERIES_GROUPS = [
    ("아시아",    ("nikkei", "hangseng", "shanghai")),
    ("미국 개별",  ("nvda", "tsm", "mu", "tsla")),
    ("원자재",    ("gold", "copper", "natgas")),
    ("심리·기타",  ("vix", "btc")),
]
