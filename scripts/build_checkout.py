...
.pm label{display:flex;align-items:flex-start;gap:12px;padding:12px 0;border-top:1px solid var(--hair);cursor:pointer} .pm .card{display:block} .pm .t{display:block;font:500 15px/22px var(--font)} .pm .d{display:block;margin-top:2px;font:400 13px/20px var(--font);color:var(--ink-62)}
...
.co-note{margin:14px 0 0;font:400 13px/20px var(--font);color:var(--ink-72)} .co-fine{margin:18px 0 0;font:400 12px/18px var(--font);color:var(--ink-62)} .co-fine a{text-decoration:underline;text-underline-offset:3px}
/* 요약 — 오른쪽에 붙박이 */
