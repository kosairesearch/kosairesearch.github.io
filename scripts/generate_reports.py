...
# ── 프롬프트 ──────────────────────────────────────────────────────────
SCHEMA_DESC = """{
  "title":     {"ko": "리포트 헤드라인(핵심 관점, 한 줄·10~16자로 짧게, 매수/매도 권유 금지)", "en": "short headline"},
...
7. 제목(title)은 핵심 관점을 담은 **짧은 한 줄 헤드라인**(10~16자)으로 작성하세요(예: "AI 메모리 사이클의 수혜주"). 길게 쓰지 말 것. 매수/매도·목표주가 등 투자권유 표현 금지.
