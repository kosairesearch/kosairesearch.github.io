...
# ── 프롬프트 ──────────────────────────────────────────────────────────
SCHEMA_DESC = """{
  "title":     {"ko": "리포트 헤드라인(핵심 관점 담은 12~25자, 매수/매도 권유 금지)", "en": "headline"},
...
7. 제목(title)은 그 리포트의 핵심 관점을 담은 **중립적 서술형 헤드라인**으로 작성하세요(예: "AI 메모리 슈퍼사이클의 핵심 수혜주"). 매수/매도·목표주가 등 투자권유 표현은 금지.
