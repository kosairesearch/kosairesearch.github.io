...
const T = {
  ko: {
    ...
    needLogin: "로그인이 필요합니다", needLoginD: "구독은 계정에 연결됩니다. 로그인하신 뒤 계속 진행하여 주시기 바랍니다.",
    login: "로그인", toPricing: "멤버십 보기",
    already: "이미 이용 중입니다", alreadyD: "현재 {plan} 플랜을 이용하고 계십니다. 플랜 변경과 해지는 구독 관리에서 하실 수 있습니다.",
    toBilling: "구독 관리로 이동",
    notReady: "결제 준비 중입니다", notReadyD: "결제 연동 설정이 아직 완료되지 않았습니다. 잠시 후 다시 시도하여 주시기 바랍니다.",
    badPlan: "요금제를 찾을 수 없습니다", badPlanD: "멤버십 페이지에서 다시 선택하여 주시기 바랍니다.",
    failTitle: "결제가 완료되지 않았습니다",
    errAgree: "필수 항목에 모두 동의하여 주시기 바랍니다.",
    errOpen: "결제창을 열지 못했습니다. 잠시 후 다시 시도하여 주시기 바랍니다.",
    errConfirm: "결제를 확인하지 못했습니다. 카드사 승인 내역을 확인하신 뒤 다시 시도하여 주시기 바랍니다.",
    done: "구독이 시작되었습니다",
    mStep: "새 결제 수단",
    mDesc: "새로 등록하신 카드로 다음 결제일부터 자동 결제됩니다. 현재 청구되는 금액은 없습니다.",
    mDue: "직전 정기결제가 정상적으로 처리되지 않았습니다. 정해진 날에 자동으로 다시 시도해 드리며, 카드를 등록하시면 기다리지 않고 즉시 결제 후 이용이 재개됩니다.",
    mBtn: "카드 등록하기",
    mAgree: "등록하신 카드로 매월 자동 결제되는 정기결제에 동의합니다. 결제가 승인되지 않는 경우 1일·3일·5일·7일째에 다시 시도되는 것에 동의합니다. (필수)",
  ...
  en: {
    ...
    mDue: "Your most recent renewal was not processed. We retry automatically on a set schedule; register a card and it will be charged immediately so you do not have to wait.",
    mBtn: "Register card",
    mAgree: "I agree to recurring monthly charges to the card I register, and to retries on days 1, 3, 5 and 7 if a charge is declined. (required)",
